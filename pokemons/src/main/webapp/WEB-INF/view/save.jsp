...
<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="margin-bottom: 20px; position:sticky; top:0; z-index: 2">
        ...
        <a class="navbar-brand" href="/hello">Create</a>
...
">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 ml-1 mr-1"  style="position:relative; z-index: 1">
        <div class="col card text-white border-0 bg-transparent" style="margin-left: 38%;">
            <div class="w-75 bg-dark mr-auto ml-auto mb-3" style="border-radius: 10px; ">
                ...
                <input class="list-group-item bg-dark" placeholder="URL IMAGE" name="url">
                <ul class="list-group list-group-flush">
                    <input class="list-group-item bg-dark" placeholder="name" name="name"/>
                    <input class="list-group-item bg-dark" placeholder="HP" name="hp"/>
                    <input class="list-group-item bg-dark" placeholder="attack" name="attack"/>
                    <input class="list-group-item bg-dark" placeholder="defense" name="defense"/>
                </ul>
                <ul class="list-group list-group-flush">

                    <select name="type" class="custom-select mr-sm-2 bg-dark" style="color: white" id="inlineFormCustomSelect">
                        <option selected>water</option>
                        <option value="fire">fire</option>
                        <option value="poison">ice</option>
                        <option value="flying">ground</option>
                        <option value="fire">grass</option>
                        <option value="poison">dark</option>
                        <option value="flying">psychic</option>
                        <option value="fire">dragon</option>
                    </select>

                </ul>
                    <input id="create" class="btn btn-outline-info my-2 my-sm-0 text-center" style="margin-left: 30%;" type="submit" value="Creaete"></input>
                </form>
            </div>
        </div>
    </div>
